...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	topLeft = float3(-size/2, size/2, 0) + origin;
	topRight = float3(size/2, size/2, 0) + origin;
	bottomLeft = float3(-size/2, -size/2, 0) + origin;
	bottomRight = float3(size/2, -size/2, 0) + origin;
	...
	topLeft = mul(topLeft - origin, gViewInverse) + origin;
	topRight = mul(topRight - origin, gViewInverse) + origin;
	bottomLeft = mul(bottomLeft - origin, gViewInverse) + origin;
	bottomRight = mul(bottomRight - origin, gViewInverse) + origin;
